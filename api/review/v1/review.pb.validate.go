...
var _CreateReviewRequest_Score_InLookup = map[int64]struct{}{
	1: {},
	2: {},
	3: {},
	4: {},
...
func (m *GetReviewReply) validate(all bool) error {
	...
	// no validation rules for AppealContent
...
func (m *ReplyReviewRequest) validate(all bool) error {
	...
	// no validation rules for CtrlJSON
...
func (m *AppealReviewRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetReason()); l < 1 || l > 50 {
		err := AppealReviewRequestValidationError{
			field:  "Reason",
...
func (m *AuditReviewRequest) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetOpRemarks()) > 255 {
		err := AuditReviewRequestValidationError{
			field:  "OpRemarks",
	...
	if l := utf8.RuneCountInString(m.GetOpUser()); l < 1 || l > 50 {
		err := AuditReviewRequestValidationError{
			field:  "OpUser",
			reason: "value length must be between 1 and 50 runes, inclusive",
		}
