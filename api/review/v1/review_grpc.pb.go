...
const (
	Review_CreateReview_FullMethodName       = "/review.v1.Review/CreateReview"
	Review_DeleteReview_FullMethodName       = "/review.v1.Review/DeleteReview"
	Review_GetReview_FullMethodName          = "/review.v1.Review/GetReview"
	Review_ListReviewByUserID_FullMethodName = "/review.v1.Review/ListReviewByUserID"
	Review_ReplyReview_FullMethodName        = "/review.v1.Review/ReplyReview"
	Review_AppealReview_FullMethodName       = "/review.v1.Review/AppealReview"
	Review_AuditReview_FullMethodName        = "/review.v1.Review/AuditReview"
)
...
type ReviewClient interface {
	...
	// 根据用户id获取评价
	ListReviewByUserID(ctx context.Context, in *ListReviewRequest, opts ...grpc.CallOption) (*ListReviewReply, error)
	// 回复评价
...
func (c *reviewClient) ListReviewByUserID(ctx context.Context, in *ListReviewRequest, opts ...grpc.CallOption) (*ListReviewReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedReviewServer) ListReviewByUserID(context.Context, *ListReviewRequest) (*ListReviewReply, error) {
...
func _Review_ListReviewByUserID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).ListReviewByUserID(ctx, req.(*ListReviewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
